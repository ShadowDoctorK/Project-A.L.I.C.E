...
{
    public class Event_PowerplayLeave : Event_Base
    {
        public Event_PowerplayLeave()
        {
            Name = "PowerplayLeave";
        }
        ...
        public void Logic()
        {
            ...
            //IObjects.Logic_PowerplayLeave((PowerplayLeave)GetEvent());
        ...
        {
            PowerplayLeave Event = (PowerplayLeave)IEvents.GetEvent(Name);
