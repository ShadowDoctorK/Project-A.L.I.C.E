...
{
    public class Event_DumpingNearStation : Event_Base
    {
        public Event_DumpingNearStation()
        {
            Name = "DumpingNearStation";
        }
        ...
        public void Logic()
        {
            ...
            Process.DumpingNearStation((DumpingNearStation)GetEvent());
        ...
        {
            DumpingNearStation Event = (DumpingNearStation)IEvents.GetEvent(Name);
        ...
        {
            DumpingNearStation Temp = new DumpingNearStation()
            {
                ChargeType = "Bounty",
    ...
    #region DumpingNearStation Event
