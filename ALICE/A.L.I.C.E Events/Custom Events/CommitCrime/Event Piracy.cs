...
{
    public class Event_Piracy : Event_Base
    {
        public Event_Piracy()
        {
            Name = "Piracy";
        ...
        public void Logic()
        {
            ...
            Process.Piracy((Piracy)GetEvent());
        ...
        {
            Piracy Event = (Piracy)IEvents.GetEvent(Name);
