...
{
    public class Event_IllegalCargo : Event_Base
    {
        public Event_IllegalCargo()
        {
            Name = "IllegalCargo";
        }
        ...
        public void Logic()
        {
            ...
            Process.IllegalCargo((IllegalCargo)GetEvent());
        ...
        {
            IllegalCargo Event = (IllegalCargo)IEvents.GetEvent(Name);
        ...
        {
            IllegalCargo Temp = new IllegalCargo()
            {
                ChargeType = "Fine",
    ...
    #region IllegalCargo Event
    public class IllegalCargo : Base
    {
