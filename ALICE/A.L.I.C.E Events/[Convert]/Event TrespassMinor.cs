...
{
    public class Event_TrespassMinor : Event_Base
    {
        public Event_TrespassMinor()
        {
            Name = "TrespassMinor";
        }
        ...
        public void Logic()
        {
            ...
            Process.TrespassMinor((TrespassMinor)GetEvent());
        ...
        {
            TrespassMinor Event = (TrespassMinor)IEvents.GetEvent(Name);
        ...
        {
            TrespassMinor Temp = new TrespassMinor()
            {
                ChargeType = "Fine",
    ...
    #region TrespassMinor Event
    public class TrespassMinor : Base
    {
