...
{
    public class Event_TrespassMajor : Event_Base
    {
        public Event_TrespassMajor()
        {
            Name = "TrespassMajor";
        }
        ...
        public void Logic()
        {
            ...
            Process.TrespassMajor((TrespassMajor)GetEvent());
        ...
        {
            TrespassMajor Event = (TrespassMajor)IEvents.GetEvent(Name);
        ...
        {
            TrespassMajor Temp = new TrespassMajor()
            {
                ChargeType = "Fine",
    ...
    #region TrespassMajor Event
    public class TrespassMajor : Base
    {
