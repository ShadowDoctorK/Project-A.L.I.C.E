...
namespace ALICE_Equipment
{
    public class Equipment_LimpetRepair : Equipment_General
    {
        ...
        public Equipment_LimpetRepair New() { return new Equipment_LimpetRepair(); }
            ...
            bool Var3 = true, int Priority = 3, string Voice = null)
        {
            ...
            Speech.Response(""
                ...
                .Speak("Repair Limpet Controller Not Installed."),
            ...
            bool Var3 = true, int Priority = 3, string Voice = null)
        {
            ...
            Speech.Response(""
                ...
                .Speak("Repair Limpet Controller Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
