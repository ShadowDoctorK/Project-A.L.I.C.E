    ...
    public class Monitor_Journal
    {
        ...
        public void Start()
        {
            ...
            if (Monitor.TryEnter(Settings.Lock))
            {
                        ...
                        if (Journal.Check())
                        {
                            ...
                            while (Journal.EventCount != Journal.EventTotal)
                            {
                                ...
                                try
                                {
                                    ...
                                    //Examples For Substring Reference:
                                    //0123456789111111111122222222223333333333444444444455555555556666666
                                    //..........012345678901234567890123456789012345678901234567890123456
                                    //{ "timestamp":"2018-10-08T15:18:09Z", "event":"Music", 
                ...
                {
                    Logger.Exception(MethodName, "Exception: " + ex);
                    Logger.Exception(MethodName, "(Failed) All The Hamsters Died...");
                }
            }
        }

        public object Deserialize(string Line, Type T)
        {
            try
            {
                //Deseraialize
                return JsonConvert.DeserializeObject(Line, T);
            }
            catch (Exception)
            {
