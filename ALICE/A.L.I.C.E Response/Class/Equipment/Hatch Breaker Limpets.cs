...
namespace ALICE_Response
{
    ...
    {
        public static Hatch_Breaker_Limpets HatchBreakerLimpets = new Hatch_Breaker_Limpets();
    }

    public class Hatch_Breaker_Limpets : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Hatch Breaker Limpet Controller Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Hatch Breaker Limpet Controller Not Installed.", Logger.Yellow); }
