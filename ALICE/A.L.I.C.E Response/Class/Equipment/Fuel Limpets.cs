...
namespace ALICE_Response
{
    ...
    {
        public static Fuel_Limpets FuelLimpets = new Fuel_Limpets();
    }

    public class Fuel_Limpets : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Fuel Limpet Controller Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Fuel Limpet Controller Not Installed.", Logger.Yellow); }
