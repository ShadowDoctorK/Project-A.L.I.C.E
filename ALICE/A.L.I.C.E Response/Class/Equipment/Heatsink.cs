...
namespace ALICE_Response
{
    ...
    public class Heatsink : Generic_Equipment
    {
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Heatsink Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Positive.Default, true)
                .Phrase("Heat Sink Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
