...
namespace ALICE_Response
{
    ...
    {
        public static ECM ECM = new ECM();
    }

    public class ECM : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Electronic Countermeasures Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Electronic Countermeasures Not Installed.", Logger.Yellow); }
