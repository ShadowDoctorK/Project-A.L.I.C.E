...
namespace ALICE_Response
{
    ...
    {
        public static FSD_Interdictor FSDInterdictor = new FSD_Interdictor();
    }

    public class FSD_Interdictor : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "FSD Interdictor Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "FSD Interdictor Not Installed.", Logger.Yellow); }
