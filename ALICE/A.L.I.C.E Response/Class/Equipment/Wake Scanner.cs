...
namespace ALICE_Response
{
    ...
    {
        public static Wake_Scanner WakeScanner = new Wake_Scanner();
    }

    public class Wake_Scanner : Generic_Equipment
    {
        /// <summary>
        ...
        {            
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Wake Scanner Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Positive.Default, true)
                .Phrase("Wake Scanner Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Wake Scanner Not Installed.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Negative.Default, true)
                .Phrase("Wake Scanner Not Installed."),
                CA, V1, V2, V3, P, V);
        }
    }
}