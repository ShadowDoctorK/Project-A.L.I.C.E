...
namespace ALICE_Response
{
    ...
    {
        public static Prospector_Limpets ProspectorLimpets = new Prospector_Limpets();
    }

    public class Prospector_Limpets : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Prospector Limpet Controller Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Prospector Limpet Controller Not Installed.", Logger.Yellow); }
