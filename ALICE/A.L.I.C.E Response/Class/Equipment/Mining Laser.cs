...
namespace ALICE_Response
{
    ...
    {
        public static Mining_Laser MiningLaser = new Mining_Laser();
    }

    public class Mining_Laser : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Mining Laser Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Positive.Default, true)
                .Phrase("Mining Laser Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Mining Laser Not Installed.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Negative.Default, true)
                .Phrase("Mining Laser Not Installed."),
                CA, V1, V2, V3, P, V);
        }
    }
}