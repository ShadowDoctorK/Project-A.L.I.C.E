...
namespace ALICE_Response
{
    ...
    {
        public static Research_Limpets ResearchLimpets = new Research_Limpets();
    }

    public class Research_Limpets : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Research Limpet Controller Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Research Limpet Controller Not Installed.", Logger.Yellow); }
