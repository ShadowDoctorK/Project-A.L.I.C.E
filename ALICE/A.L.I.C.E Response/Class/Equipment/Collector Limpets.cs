...
namespace ALICE_Response
{
    ...
    {
        public static Collector_Limpets CollectorLimpets = new Collector_Limpets();
    }

    public class Collector_Limpets : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Collector Limpet Controller Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Collector Limpet Controller Not Installed.", Logger.Yellow); }
