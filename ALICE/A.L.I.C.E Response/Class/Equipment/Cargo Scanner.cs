...
namespace ALICE_Response
{
    ...
    {
        public static Cargo_Scanner CargoScanner = new Cargo_Scanner();
    }

    public class Cargo_Scanner : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Cargo Scanner Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Positive.Default, true)
                .Phrase("Cargo Scanner Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Cargo Scanner Not Installed.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Negative.Default, true)
                .Phrase("Cargo Scanner Not Installed."),
                CA, V1, V2, V3, P, V);
        }
    }
}