...
namespace ALICE_Response
{
    ...
    {
        public static Surface_Scanner SurfaceScanner = new Surface_Scanner();
    }

    public class Surface_Scanner : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Surface Scanner Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Surface Scanner Not Installed.", Logger.Yellow); }
