...
namespace ALICE_Response
{
    ...
    {
        public static Chaff_Launcher ChaffLauncher = new Chaff_Launcher();
    }

    public class Chaff_Launcher : Generic_Equipment
    {
        /// <summary>
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Chaff Launcher Assigned To Group " + Group + " " + FireMode + " Fire.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Positive.Default, true)
                .Phrase("Chaff Launcher Assigned To Group [GROUP], [FIREMODE] Fire.")
                .Token("[GROUP]", Group)
        ...
        {
            if (PlugIn.MasterAudio == false) { Logger.Log(ClassName, "Chaff Launcher Not Installed.", Logger.Yellow); }

            Speech.Speak(""
                .Phrase(GN_Negative.Default, true)
                .Phrase("Chaff Launcher Not Installed."),
                CA, V1, V2, V3, P, V);
        }
    }
}